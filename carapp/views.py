...
from carapp.models import Customers,Users,CarVariant,Category,JourneyStage,Drivers,Payment,Bookings,Car
...
def registerpage(req):
    if(req.method=="POST"):
        ...
        user.save()
        #send_mail('Registration Successfull','Your registration is now complete','vemana.madhu@gmail.com',recipient_list=(userid,),fail_silently=False)
